...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var i = 0;
    var teste = document.getElementsByClassName("randomPizzaContainer");
    var dx = determineDx(teste[i], size);
    var newwidth = (teste[i].offsetWidth + dx) + 'px';
